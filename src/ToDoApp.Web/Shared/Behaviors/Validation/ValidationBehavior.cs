...
namespace ToDoApp.Web.Shared.Behaviors.Validation;

public sealed class ValidationBehavior<TMessage, TErrorOrValue>(
    IEnumerable<IValidator<TMessage>> thisValidators
